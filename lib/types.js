 ...
 * @property {string} sessionId
 * @property {'user_message'|'assistant_message'|'tool_call'|'tool_result'|'turn_start'|'turn_end'|'session_started'|'session_ended'|'hypothesis_submitted'} kind
 ...
 * @typedef {'session.started'|'intervention.triggered'|'hypothesis.submitted'|'hypothesis.challenged'|'decision.recorded'|'teaching_back.requested'|'teaching_back.completed'|'knowledge_gap.detected'|'session.ended'} CognitiveEventType
 */
